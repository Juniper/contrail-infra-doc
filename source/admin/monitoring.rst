...
http://148.251.5.91/grafana while Graphite's at http://148.251.5.91/graphite. The Grafana admin
account credentials are available in password storage repository_.
...
.. _repository: file://tobedecided.png
